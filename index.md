...
<div style="display: flex; gap: 40px; align-items: flex-start; flex-wrap: wrap; margin-bottom: 30px;">
  ...
  <div style="flex: 3; min-width: 300px;">
    ...
    ### **Research Intern** — SAILab & VIMP Group, University of Siena and University of Padova
    * Worked on action progress prediction in videos: [Multiview Progress Prediction of Robot Activities, ICASSP 2026](https://arxiv.org/abs/2603.00151).
